...
# Initial `load_transition`, `genvar_transition`, `mlt_transition`, and `solver_params`
...
function run_model(ty, lg, wy, sn)
    ...
    # Read solver parameters and assign to the global variable
    ...
    # Initialize `load_transition`, `genvar_transition`, and `mlt_transition`
    ...
    # Invoke the model and results functions
