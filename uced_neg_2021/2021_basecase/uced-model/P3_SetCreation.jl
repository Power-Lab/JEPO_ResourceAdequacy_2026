...
setZONE = unique(generators.Zone) # Zones
int_generators = filter(row -> row.region != "SD" && row.region != "JB", generators) # Exclude SD/JB generators
