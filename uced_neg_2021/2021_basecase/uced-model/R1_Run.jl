...
# Initialize `load_transition`, `genvar_transition`, `mlt_transition`, and `solver_params`
...
function run_model(ty, lg, wy, sn)
    ...
    # Read solver parameters and assign to global scope
    ...
    # Invoke model and results functions
